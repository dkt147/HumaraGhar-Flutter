...
import 'package:HumaraGhar/view/main_screen/favorites_view/favorites_view.dart';
...
class AppRoutes {
 ...
 static appRoutes () => [
  ...
  GetPage(
    ...
    page: () => ProjectsView(isSearchResultView: false ,),transition: Transition.fadeIn),

                    // FilterProjectsView inn search page index 1
  GetPage(
    name: RouteName.filterProperties , 
    page: () => ProjectsView(isSearchResultView: true ,),transition: Transition.fadeIn),
  ...
  GetPage(
    ...
    page: () => SelectNearbyLocationScreen(),transition: Transition.fadeIn),
