import 'dart:io';
import 'package:HumaraGhar/API/FavoriteIconProperty/favorite_property_icon.dart';
import 'package:HumaraGhar/API/GetSingleProperty/service.dart';
...
class GetSinglePropertyView extends StatefulWidget {
  final String propertyId;

  const GetSinglePropertyView({
    super.key,
    required this.propertyId,
  });

  @override
  State<GetSinglePropertyView> createState() => _GetSinglePropertyViewState();
}

class _GetSinglePropertyViewState extends State<GetSinglePropertyView> {
  late Future<PropertyListModel> _futureProperty;
  ...
  void initState() {
    super.initState();
    _futureProperty =
        GetSinglePropertyServices().getSingleProperty(widget.propertyId);
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView(
                      children: [
                        // Image Slider
                        carouselWithIndicator(property, height),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(property[0].propertyCity.name,
                                  style: GoogleFonts.robotoFlex(
                                      fontSize: 20,
                              ...
                              featureMainContainer(
                                  internalContainerWidth: width * .4),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    property[0].propertyTypes[0].name,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.w500,
                                        fontSize: 18),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    property[0].propertyHouseTypes[0].name,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.w500,
                                        fontSize: 18),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  //  Text(property[0].floorPlans[0].title , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w500 , fontSize: 18 ),),
                                ],
                              ),
/////////////////

// Inside your existing code, after displaying the number of bedrooms
...
// ),
/*
// Display feature subtypes
SizedBox(height: height * .01,),
Text('Feature Subtypes:', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 18)),
SizedBox(height: height * .01,),
// Display feature subtypes using ListView.builder
ListView.builder(
  shrinkWrap: true,
  physics: NeverScrollableScrollPhysics(),
  itemCount: property[0].featuresSubType.length,
  itemBuilder: (context, index) {
    // Get the feature subtype category
    var category = property[0].featuresSubType.keys.elementAt(index);
    // Get the list of feature subtypes for the current category
    var subtypes = property[0].featuresSubType[category]!;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        // Display each feature subtype for the current category
        Column(
          children: subtypes.map((subtype) {
            return Text(
              subtype.sName, // Assuming sName is the name of the feature subtype
...
/////////////////
                              ...
                              //   children: [
                              //     Text('No of Bedrooms :' , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w500 , fontSize: 18 ),),
                              //      Text(property[0].featuresSubType , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w500 , fontSize: 18 ),),
                              //   ],
                              // ),
                              ...
                              mapLocation(height * .3,
                                  property[0].propertyLocations[0].location),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    property[0].propertyDevelopers[0].name,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 18),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    property[0].propertyDevelopers[0].email,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 18),
                    ...
                    return Text('Failed to load property');
                  }
                }),
          ),
  ...
  Stack carouselWithIndicator(List<Property> property, double height) {
    return Stack(
      children: [
            ...
            children: [
              Center(
                child: AnimatedSmoothIndicator(
                  ...
                  count: property[0].propertyAttachments.length,
  ...
  CarouselSlider ImageSlider(List<Property> property) {
  ...
  Widget mapLocation(height, String location) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  ConstrainedBox featuresInsideContainer(
      {internalContainerWidth, featureHeading, feature1, feature2}) {
    return ConstrainedBox(
      constraints: BoxConstraints(maxHeight: double.infinity),
      child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.check,
                            color: const Color.fromARGB(255, 14, 146, 255),
                            size: 14),
                        SizedBox(
                          width: 6,
                        ),
            ...
            child: Row(
              ...
              children: [
                ...
                squareButton(
                    ...
                    titleColor: const Color.fromARGB(255, 52, 138, 55),
                    buttonTitle: 'WhatsApp',
                    buttonIcon: Icons.message,
                    iconColor: const Color.fromARGB(255, 52, 138, 55)),
              ],
            ),
          ),
  ...
  openPhoneApp() async {
    final Uri url = Uri(scheme: 'tel', path: '923118706843');
    if (await canLaunchUrl(url)) {
      await launchUrl(url);
    } else {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Can not call')));
    }
  }
}
