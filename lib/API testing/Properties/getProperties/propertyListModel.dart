...
//   // final Map<String, List<Map<String, String>>> featuresSubType;
...
//       //  featuresSubType: Map<String, List<Map<String, String>>>.from(json['features_sub_type'] ?? {}),
//       // featuresSubType: Map<String, List<Map<String, String>>>.from(json['features_sub_type']),
//       //  featuresSubType: (json['features_sub_type'] as Map<String, dynamic>).map<String, List<Map<String, String>>>(
//       //   (key, value) => MapEntry<String, List<Map<String, String>>>(
//       //     key,
...
//           .map((property) => Property.fromJson(property)).toList(),
//     );
//   }
// }
...
class Property {
  ...
  final List<PropertyArea> propertyAreas;
  final List<PropertyCategory> propertyCategories;
  final List<PropertyDeveloper> propertyDeveloper;
  final List<PropertyHouseType> propertyHouseType;
  ...
  factory Property.fromJson(Map<String, dynamic> json) {
    return Property(
      ...
      propertyCategories: (json['property_category'] as List)
          .map((category) => PropertyCategory.fromJson(category))
          .toList(),
      propertyDeveloper: (json['property_developer'] as List)
          .map((developer) => PropertyDeveloper.fromJson(developer))
          .toList(),
      propertyHouseType: (json['property_house_type'] as List)
      ...
      propertyType: (json['property_type'] as List)
          ...
          .toList(),
      propertyLocation: (json['property_location'] as List)
