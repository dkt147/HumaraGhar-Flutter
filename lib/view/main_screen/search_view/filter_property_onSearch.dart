...
class FilterProjectOnSearch extends StatefulWidget {
  final String? cityId;
  final String? priceMin;
  final String? priceMax;
  final String? areaMin;
  final String? areaMax;
  final bool isSearchResultView; // Indicates if it's a search result view

  const FilterProjectOnSearch({super.key, required this.isSearchResultView,required this.cityId,required this.priceMin,required this.priceMax,required this.areaMin,required this.areaMax});

  @override
  State<FilterProjectOnSearch> createState() => _FilterProjectOnSearchState();

   
}

class _FilterProjectOnSearchState extends State<FilterProjectOnSearch> {
  
  late Future<PropertyListModel> filterPropertyList;

  @override
  void initState() {
    super.initState();
    filterPropertyList = _searchProperties();
  }
 Future<PropertyListModel> _searchProperties() {
    return SearchPropertyService.searchProperties(
      cityId:  widget.cityId ?? null,
      priceMin: widget.priceMin ?? null,
      priceMax: widget.priceMax ?? null,
      areaMax: widget.areaMax ?? null,
      areaMin: widget.areaMin ?? null
    );
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
           systemOverlayStyle: SystemUiOverlayStyle(
             ...
             title : Text('Filter Properties Result')),
          body: FutureBuilder<PropertyListModel>(
            future: filterPropertyList, 
               ...
               children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Showing ${propertyList.length} properties results.' ,style: GoogleFonts.robotoFlex(color: Colors.white),),],
                ),
              ),
