...
class _ProjectDetailsWithObjectsState extends State<ProjectDetailsWithObjects> {
 ...
 Widget carouselWithIndicator({height , title , description , required List<String> imageUrl ,  price , location , contactInfo , isFavorite , userID , propertyID} ){
  ...
  ImageSlider(height: height ),
        ...
        child:   Row(
          children: [
          CircleAvatar(backgroundColor: Colors.transparent, child: FavoritePropertyIcon(userId: userID, propertyId: propertyID ,)),
            SizedBox(width: 1,),
