                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                widget.property.propertyTypes[0].name,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18),
                          ...
                          Row(
                            ...
                            children: [    
                              ...
                              Text(
                                widget.property.propertyHouseTypes[0].name,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                // widget.property.floorPlans[0].title,
                                'floorplan_title',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500,
...
ListView.builder(
  ...
  itemCount: widget.property.featuresSubType.length,
  itemBuilder: (context, index) {
    // Get the feature subtype category
    var category = widget.property.featuresSubType.keys.elementAt(index);
    // Get the list of feature subtypes for the current category
    var subtypes = widget.property.featuresSubType[category]!;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
...
//
                          ...
                          mapLocation(height * .3,
                              widget.property.propertyLocations[0].location),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                // widget.property.propertyDevelopers[0].name,
                               'devloper naems',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w600,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                // widget.property.propertyDevelopers[0].email,
                                'email@gmail.com',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w600,
          ...
          bottomNavigationBar: Container(
            child: StickeyFooter(
                height: height,
                phoneNumber: widget.property.propertyDevelopers[0].phone),
          )
  ...
  CarouselSlider ImageSlider({required height}) {
    return CarouselSlider(
      items: widget.property.propertyAttachments
            ...
            children: [
              Center(
                child: AnimatedSmoothIndicator(
                  ...
                  count: widget.property.propertyAttachments.length,
  ...
  openMap({required String locationUrl}) async {
    ...
    if (await canLaunchUrl(location)) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Map is not installed')));
    }
  }
}
