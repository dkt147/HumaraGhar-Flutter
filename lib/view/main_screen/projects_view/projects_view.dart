...
class ProjectsView extends StatefulWidget {
  ...
  const ProjectsView({super.key, required this.isSearchResultView});
               ...
               children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Showing ${propertyList.length} properties results.' ,style: primaryWhiteTextStyle(fontSize: 15, fontWeight: FontWeight.w400),),],
                ),
              ),
            ...
            children: [
              ...
              SizedBox(width: 12,),
                Column(
                  ...
                  //      Text(ownerInfo , style : TextStyle( fontWeight: FontWeight.w500, fontSize: 14 , color: const Color.fromARGB(255, 9, 21, 30))),
                   Wrap(children:[Text(projectTitle , style: primaryWhiteTextStyle(fontSize: 18, fontWeight:  FontWeight.bold))] ) ,
                  //  Text(projectLocation , style: TextStyle( fontWeight: FontWeight.w500, fontSize: 14 ,color: Colors.white)) ,
                   Text(projectLocation , style: primaryWhiteTextStyle(fontSize: 14, fontWeight:  FontWeight.w500)) ,
                   SizedBox(height: height * .15,),
                  //  Text("PKR ${projectPrice}"  , style: TextStyle( fontWeight: FontWeight.bold, fontSize: 14 ,color: Colors.white)) ,
                   Text("PKR ${projectPrice}"  , style: primaryWhiteTextStyle(fontSize: 14, fontWeight:  FontWeight.bold)) ,
                    
                      //  Text(ownerInfo , style : TextStyle( fontWeight: FontWeight.w500, fontSize: 14 , color: const Color.fromARGB(255, 9, 21, 30))),
                       Text(ownerInfo , style : primaryWhiteTextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                    GestureDetector(
                      onTap: (){},
                      // child: Text('View Project' , style : TextStyle( fontWeight: FontWeight.w500, fontSize: 14 , color: Colors.blue))), 
                      child: Text('View Project' , style : primaryBlueTextStyle(fontSize: 14, fontWeight: FontWeight.w600))), 
                        ],)
                    ],),
                  ],),
                ),),
