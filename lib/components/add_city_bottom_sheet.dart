                                    ...
                                    child: Obx(
                                      ()=> ListView.builder(
                                        ...
                                        itemBuilder: (context , index){
                                          final city = cityController.filterCity[index];
                                          return InkWell(
                                            
                                            onTap: (){
                                              //  print('Hello');
                                               print('selected id ' + cityController.selectedCity.value.id);
                                              // cityController.updateSelectedCity(cityController.cities[index].toString());
                                              cityController.updateSelectedCity(city);
                                            ...
                                            title: Text(city.name , style: TextStyle(color: Colors.black),) ,
                                          ));
                    ...
                    children: [Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(cityController.selectedCity.value.name , style: TextStyle(color: Color.fromARGB(255, 1, 78, 141) , fontSize: 18),)
                        ],
                      ),
                    )],
                  ),
