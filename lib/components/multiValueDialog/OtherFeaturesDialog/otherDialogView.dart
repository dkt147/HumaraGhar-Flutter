    ...
    return  Column(
        ...
        children: [
          Row(
            ...
            children: [
              InkWell(
                onTap:() => otherFeaturesController.showMultiSelectOtherFacilities(),
                child: Container(
                  height: height * .07 ,
                  width: width  * .9,
                child: Row(
          ...
          Obx(
            () => Wrap(
              children: otherFeaturesController.selectedFeatures.map(
                (item) => Padding(
