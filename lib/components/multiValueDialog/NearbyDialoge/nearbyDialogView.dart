    ...
    return  Column(
        ...
        children: [
          Row(
            ...
            children: [
              InkWell(
                onTap:() => nearbyLocationController.showMultiSelectNearbyLocations(),
                child: Container(
                  height: height * .07 ,
                  width: width  * .9,
                child: Row(
          ...
          Obx(
            () => Wrap(
              children: nearbyLocationController.selectedFeatures.map(
                (item) => Padding(
